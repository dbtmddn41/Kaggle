...
def main(cfg: DictConfig):
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(cfg.dir.model_save_dir+'/'+cfg.model.model_name+'.'+cfg.save_extention, monitor='val_average_precision', save_best_only=True, mode='max', options=None),
